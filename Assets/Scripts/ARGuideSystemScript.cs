...
public class ARGuideSystemScript : MonoBehaviour
{
    ...
    public void Texter()
    {
        ...
        //TextGuidetexter = GameObject.Find("Texter");
        //TextGuidetexter.SetActive(true);
        //TextGuideObject = Instantiate(textImage, new Vector3(this.gameObject.transform.position.x, this.gameObject.transform.position.y, this.gameObject.transform.position.z), Quaternion.identity);
        //TextGuideObject.transform.parent = GameObject.Find("Center1").gameObject.transform;
